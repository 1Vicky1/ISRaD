 ...
 * **_How do I convert radiocarbon age (in years BP) into Fraction modern units?_**<br>
   > radiocarbon age = -8033 * ln (F<sub>m</sub>)
   
   Some additional information on radiocarbon units and calucations is available [here](http://www.whoi.edu/nosams/radiocarbon-data-calculations)  
* **_How do I convert standard deviation in radiocarbon age (in years BP) into standard deviation in Fraction modern?_**<br>
  ...
  > error_F<sub>m</sub> = F<sub>m</sub> * error<sub>age</sub> / 8033, <br>
    
  where F<sub>m</sub> is fraction modern.
 * **_How do I convert pMC (Percent modern carbon) into Fraction modern units?_**<br>
   > F<sub>m</sub> = pMC/100  
 ...
 * **_What is a density separation?_** <br>
 ...
 * **_What is a sequential density separation?_**  <br>
...
* **_What is particle size separation?_** <br>  
 ...
 * **_What is aggregate fractionation?_** <br>
 ...
 * **_What are dummy fractions and when are they needed_** <br>  
 ...
 * **_What are autofilled templates and why should I care?_** <br>
 ...
 * **_Why do these templates look different?_** <br>
 ...
 * **_The original data source  does not mention bulk density, but the automatically generated template includes bulk density values. Should I keep them in the template?_**<br>
 ...
 * **_The names in the template don't match the paper. What do I do?_** <br>
 ...
 * **_The paper has additional fraction, flux, or incubation data, not reported in the current template. What should I do with it?_**<br> 
   If you have time, please add it! Otherwise, please make a note of the availability of additional 
   sets within the paper in the **_metadata_note_** field.
</p>
</details>
